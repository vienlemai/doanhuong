...
<?php echo $this->Form->create('Thuoc'); ?>
	<fieldset>
		<legend><?php echo __('Edit Thuoc'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Thuoc.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Thuoc.id'))); ?></li>
